...
#other file
from data_extract_eu152_0203_74 import bin_no, energy_data, livetime_data, isotope
...
leadshield_position_v = 0
leadshield_position_h = -5
leadshield_length = 10
leadshield_width = 2
leadshield_height = 9
sourcedistance = 7.4 + be_cap_cyl_pos + be_cap_cyl_height

world_boundary = openmc.Sphere(r=13, boundary_type='vacuum')
...
#source_sphere = openmc.Sphere(r=0.1,  x0=0, y0=0, z0=sourcedistance, boundary_type='transmission')
...
#source_cell = openmc.Cell(region=source_sphere_region)
...
#plotxz = geometry.plot(pixels=(1000,1000), basis='xz', colors=color_assignment)
#plotxz.figure.savefig("eu152_0203/plots_eu152_0203"+"/xz-cell.png")
#plotxy = geometry.plot(pixels=(1000,1000), origin=(0, 0, -8.9), basis='xy', colors=color_assignment)
