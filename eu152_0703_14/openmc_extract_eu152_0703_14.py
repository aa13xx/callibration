...
import sys
#other files
from openmc_eu152_0703_14 import energy_bins, sim_batch, sim_particle, tally_1, tally_1_type, source_activity
from data_extract_eu152_0703_14 import isotope

#extract tallies into pandas df
sp = openmc.StatePoint(f"{isotope}" + f"/statepoint.{sim_batch}.h5")
